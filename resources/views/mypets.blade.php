	...
	<head>
		...
		<body>
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
						 <li><a href="{{action('Shelter@pets')}}">All pets</a></li>
				        	@foreach($categories as $category)
						  		<li><a href="{{action('Shelter@pets',$category->id)}}">{{$category->name}}</a></li>
						  	@endforeach
						  	@if(isset($petlover_id))
						  		<li><a href="{{$href0}}">My pets</a></li>
						  	@endif						 
				          <li><a href="{{$href1}}">{{$Menu1}}</a></li>
				          <li><a href="{{$href2}}">{{$Menu2}}</a></li>						  
				        </ul>
			...
			<section class="cat-list-area section-gap">
				<div class="container">
				@foreach($myAdoptions as $adoption)
				  <div class="media">
					<div class="media-left">
					  <img src="{{asset('resources/assets/img/'.$adoption->image)}}" alt="" class="img-fluid">
					</div>
					<div class="media-body">
					  <h3 class="mb-30">&nbsp;{{$adoption->name}}</h3>
					  <h4 class="media-heading">&nbsp;{{$adoption->description}}</h4>
