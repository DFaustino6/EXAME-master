					...
					<div class="row">
						<div class="active-image-carusel">
							<div class="single-image-carusel">
								<img class="img-fluid" src="{{asset('resources/assets/img/c1.jpg')}}" alt="">
							</div>
							<div class="single-image-carusel">
								<img class="img-fluid" src="{{asset('resources/assets/img/c2.jpg')}}" alt="">
							</div>
							<div class="single-image-carusel">
								<img class="img-fluid" src="{{asset('resources/assets/img/c3.jpg')}}" alt="">
							</div>
							<div class="single-image-carusel">
								<img class="img-fluid" src="{{asset('resources/assets/img/c4.jpg')}}" alt="">
							</div>	
							<div class="single-image-carusel">
								<img class="img-fluid" src="{{asset('resources/assets/img/c1.jpg')}}" alt="">
							</div>
